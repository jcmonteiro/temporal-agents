...
| 3 | DONE | [`prompts`](./archive/prompts/) — foundation slices | prompts are stored, scoped per location, versioned, and every run records which prompt version it used | 1 |
...
| 6 | DONE | [`prompts`](./archive/prompts/) — configuration slices | prompts are editable globally and per location, with resets to inherited and to factory | 3 |
