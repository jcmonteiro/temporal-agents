# Vertical slices — Human-in-the-loop steering

| # | Slice | Demo |
|---|-------|------|
| 1 ✅ | [Pause and decide](./01-pause-and-decide.md) | with steering on, a review round pauses; the run reports that it needs input; a decision sent by hand resumes it |
| 2 ✅ | [Sessions and decisions through the API](./02-sessions-api.md) | the hub reads the waiting session and its material, and sends a decision, authenticated |
| 3 ✅ | [Being questioned](./03-questioning-agent.md) | the operator asks to be questioned; the agent asks one question at a time and produces editable guidance |
...
(IB §4). Slice 7 turns the limit into a decision (IB §2).
