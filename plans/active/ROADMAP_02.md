...
| 2 | IN-PROGRESS | Improve `/settings` | [`02-settings`](./ui-design-improvement/slices/02-settings.md) | settings become clear, calm, and consistent across forms and states | 1 |
